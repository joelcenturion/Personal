...
class _PersonState extends State<Person> {
  ...
  void initState() {
    ...
    if (Platform.isAndroid) {
      Mrzflutterplugin.registerWithLicenceKey(
          "5B423FDECC8A9C8A147C2DD6DC620CA08FDF64E2D26C662CC924163D574E025378E1DA1B059617616367BAD9D873364627DF34FA9F15752EFEC5B11F7FDBF3B1");
  ...
  Future<void> startScanning() async {
    ...
    try {
      ...
      print('CI: ${jsonResult['document_number']}');
  ...
  Color personalColor = const Color(0xff00B0EB);
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: Color(0xff00B0EB), // status bar color
    ));
